...
from tkinter import ttk, Label, Entry, Button, messagebox, Frame
...
users = {"user": "password"}
employees = {"E001": "Alice", "E002": "Bob", "E003": "Rasnim","E004": "Sadia", "E005": "Mahfuz", "E006": "Rahim"}
...
class HandTrackingApp:
    ...
    def select_employee(self):
        ...
        print(f"Selected Employee ID: {self.emp_id}, Name: {self.emp_name}")  # Debugging line
        self.main_screen()
